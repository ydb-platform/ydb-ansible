...
Metrics collection requires Prometheus with YDB-specific configuration files generated by Ansible playbook. The `generate_promconf` playbook generates complete Prometheus configurations including target definitions.  
**Usage**  
```bash
